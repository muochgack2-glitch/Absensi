                ...
                <div class="card-body" style="background: var(--bg-primary); color: var(--text-primary);">
                    ...
                    <div id="diagnosticsStatus" class="mb-3">
                        <div class="text-center py-3">
                            ...
                            <p class="mt-2 mb-0" style="color: var(--text-secondary);">Loading diagnostics...</p>
                        </div>
                    </div>
                    ...
                    <div id="fixHistoryPanel" class="mt-4" style="display: none;">
                        <h6 class="mb-3" style="color: var(--text-primary);"><i class="fas fa-history me-2"></i>Fix History (Last 10)</h6>
