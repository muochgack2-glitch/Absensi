...
<?php $component->withAttributes([]); ?>
     ...
     <?php $__env->slot('pageTitle', null, []); ?> WA Gateway <?php $__env->endSlot(); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.input','data' => ['type' => 'text','name' => 'phone','label' => 'Nomor WhatsApp','placeholder' => '628123456789','pattern' => '^628[0-9]{9,12}$','helper' => 'Format: 628XXXXXXXXX','required' => true]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['type' => 'text','name' => 'phone','label' => 'Nomor WhatsApp','placeholder' => '628123456789','pattern' => '^628[0-9]{9,12}$','helper' => 'Format: 628XXXXXXXXX','required' => true]); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
        ...
        function whatsappGateway() {
            return {
                ...
                async logout() {
                    ...
                    try {
                        const response = await fetch('/whatsapp/logout', { method: 'POST', headers: { 'X-CSRF-TOKEN': '<?php echo e(csrf_token()); ?>' } });
                        const data = await response.json();
                ...
                async restart() {
                    ...
                    try {
                        const response = await fetch('/whatsapp/restart', { method: 'POST', headers: { 'X-CSRF-TOKEN': '<?php echo e(csrf_token()); ?>' } });
                        const data = await response.json();
...
<?php endif; ?>
<?php /**PATH C:\Users\DMCenter\Music\SPMB2\SPMB\absensi\resources\views/attendance/whatsapp/index.blade.php ENDPATH**/ ?>